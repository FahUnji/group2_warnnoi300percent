...
export default function Sidebar({ projectKey, projectName, activePage, isOpen, onClose }) {
  ...
  return (
    <>
      <div
        ...
        aria-hidden="true"
      />
      <aside className={`${styles.sidebar} ${isOpen ? styles.open : ''}`} aria-label="Page navigation">
