...
last_updated: "2026-05-11T08:01:33.205Z"
...
- Init: Python backend (FastAPI or Flask) + React frontend
- Init: Jira API token Basic Auth — no OAuth for v1
- Init: Manual sync only — no auto-sync for v1
